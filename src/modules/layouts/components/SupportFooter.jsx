...
// Import path adjusted (usually 2 levels up for components in modules/layouts/components)
...
const SupportFooter = () => {
  // Destructure scrollToSection from your custom hook
  ...
  const socialLinks = [
    ...
    {
      Icon: FaInstagram,
      link: "https://www.instagram.com/rx__rayhan__7/?hl=en",
    },
    {
      Icon: FaLinkedinIn,
      link: "https://www.linkedin.com/in/rayhan-4a1117336/",
    },
  ...
  return (
    <footer className="relative z-10 bg-black text-gray-200 overflow-hidden border-t border-white/5">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 text-center sm:text-left">
          ...
          <div className="flex flex-col gap-6 items-center sm:items-start">
            <h3 className="text-2xl font-bold text-white mb-4 underline decoration-[#F6c543] underline-offset-8 decoration-2">
              Contact Me
            </h3>
            <a
              href="tel:+8801518979553"
              className="flex items-center gap-4 group cursor-pointer"
            >
              <FaPhoneAlt className="text-[#F6c543] text-lg transition-transform group-hover:scale-110" />
              <span className="group-hover:text-[#F6c543] transition-colors">
                +880 1518-979553
              </span>
            </a>
            <a
          ...
          <div className="flex flex-col gap-4 items-center sm:items-start">
            ...
            <ul className="grid grid-cols-2 sm:flex sm:flex-col gap-3">
              {[
                "Home",
                "About",
                "Services",
                ...
                <li key={link}>
                  <button
                    ...
                    className="relative group text-gray-400 hover:text-[#F6c543] transition-colors inline-block cursor-pointer bg-transparent border-none p-0 outline-none"
                  >
                    {link}
          ...
          <div className="flex flex-col gap-4 items-center sm:items-start">
            ...
            <div className="w-full h-48 rounded-2xl overflow-hidden shadow-2xl">
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d118096.3400262423!2d91.73142718131343!3d22.356851000000005!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30acd8a64095dfd3%3A0x5015cc5ca6bc84a!2sChattogram!5e0!3m2!1sen!2sbd!4v1710000000000"
      ...
      {/* Decorative Glows */}
      <div className="absolute top-0 left-0 w-40 h-40 bg-indigo-600 opacity-10 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-0 right-0 w-60 h-60 bg-purple-800 opacity-10 rounded-full blur-3xl animate-pulse"></div>
    </footer>
  );
};
